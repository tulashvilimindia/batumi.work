/**
 * JobRow Component - V5 Enhanced Folk Edition
 * Mobile-first design with enhanced freshness indicators
 */
...
export function JobRow({ job, onClick, className }: JobRowProps) {
  ...
  const showFreshnessBadge = freshnessLevel !== 'normal';
        ...
        <div className="hidden md:block">
          <div className="flex items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1">
              {showFreshnessBadge && (
                <JobFreshnessBadge publishedAt={job.published_at} />
              )}
              {job.is_vip && (
                <span
