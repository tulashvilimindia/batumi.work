 ...
 * Social media share buttons for job listings
 */
      ...
      {platforms.map((platform) => {
        ...
        return (
          <button
            ...
            className={cn(
              'inline-flex items-center justify-center rounded-full text-white transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2',
              config.color,
              config.hoverColor,
              sizeStyles.button,
          ...
          >
            ...
            {showLabels && (
              <span className="text-sm font-medium">{t(`share.${platform}`)}</span>
            )}
          </button>
        );
      })}
